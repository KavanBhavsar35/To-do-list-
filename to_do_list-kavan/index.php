    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            closeButtonSignup.addEventListener("click", function () {
                signupFormContainer.classList.remove("slide-down");
            ...
            closeButtonLogin.addEventListener("click", function () {
                loginFormContainer.classList.remove("slide-down");
                loginFormContainer.classList.add("slide-up");
            ...
            signupButton.addEventListener("click", function () {
                ...
                signupFormContainer.classList.remove("d-none", "slide-up");
                signupFormContainer.classList.add("slide-down");
            ...
            loginButton.addEventListener("click", function () {
                ...
                loginFormContainer.classList.remove("d-none", "slide-up");
                loginFormContainer.classList.add("slide-down");
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            editButtons.forEach(function (button) {
                button.addEventListener('click', function () {
                    ...
                    // var button = taskRow.querySelector('.edit')
            ...
            var contentEditableFields = document.querySelectorAll('[contenteditable="true"]');
            contentEditableFields.forEach(function (field) {
                field.addEventListener('blur', function () {
                    // You can add code here to handle saving changes if needed
                });
            });

            var completeButton = document.querySelectorAll('.completed');
            completeButton.forEach(function (button) {
                button.addEventListener('click', function () {
                    ...
                    var desc = taskRow.querySelector('.desc');
                    var flexRow = button.querySelector('.d-flex .flex-row');
                    var editButton = taskRow.querySelector(".edit");

                    if (button.classList.contains('completed')) {
                        button.classList.remove("btn-success", "completed");
                        button.classList.add("btn-danger", "pending");
                        title.style.textDecoration = "line-through";
                        desc.style.textDecoration = "line-through";
                        flexRow.innerHTML = '<i class="bi bi-x-circle" style="padding-right: 5px;"></i>Mark&nbsp;Pending'
                        editButton.classList.add("d-none");
                    } else if (button.classList.contains('pending')) {
                        button.classList.remove("btn-danger", "pending");
                        button.classList.add("btn-success", "completed");
                        flexRow.innerHTML = '<i class="bi bi-check-circle" style="padding-right: 5px;"></i>Mark&nbsp;Done'
...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navigation pb-0 ">
        <div class="container ">
            <a class="navbar-brand  navigationContent" href="https://github.com/JatinKevlani/to_do_list.git"
                target="_blank"><i class="bi bi-card-checklist"></i> To Do List</a>
                ...
                if (isset($_SESSION['user'])) {
                    echo "
                            <ul class='navbar-nav ms-auto'>
                                <li class='nav-item'><a href='#profile' class='nav-link loginNavLink  navigationContent'><i class='bi bi-person'></i>$user[1]</a></li>
                                <li class='nav-item'><a href='../backend/logout.php' class='nav-link loginNavLink  navigationContent'><i class='bi bi-box-arrow-in-left'></i> Logout</a></li>
                        </ul>
                        ";
                } else {
                    echo "
                            <ul class='navbar-nav ms-auto'>
                                <li class='nav-item'><a id='signupButton' class='nav-link loginNavLink  navigationContent'><i class='icon bi bi-person-plus'></i><i class='icon-fill bi bi-person-plus-fill'></i> Signup</a></li>
                                <li class='nav-item'><a id='loginButton' class='nav-link loginNavLink  navigationContent'><i class='icon bi bi-lock'></i><i class='icon-fill bi bi-lock-fill'></i> Login</a></li>
                            </ul>
                        ";
                }
                ?>
    ...
    <main>
                            ...
                            if (!isset($_SESSION['user'])) {
                                ...
                                echo "
                                        ...
                                        <div class='dropdown-center d-md-none'>
                                            <button class='btn bg-dark text-white dropdown-toggle buttonDropdown' type='button' id='dropdownMenuButton' data-bs-toggle='dropdown' aria-haspopup='true' aria-expanded='false'> <i class='bi bi-gear'></i> Actions</button>
                                            <div class='dropdownMenu dropdown-menu' aria-labelledby='dropdownMenuButton'>
                                                <button class='dropdown-item btn bg-dark text-white' data-bs-toggle='modal' data-bs-target='#inputModal'><i class='bi bi-plus'></i> Add</button>
                                                <button class='px-4 btn bg-dark text-white mb-2' data-bs-toggle='modal' data-bs-target='#inputModal'><span><i class='bi bi-plus'></i></span> Add</button>
                                            </div>
                                        </div>
                                        <div class='d-none d-md-flex flex-md-column align-items-md-stretch ms-auto'>
                                            <button class='px-4 btn bg-dark text-white mb-2' data-bs-modal='modal' data-bs-target='#inputModal'>
                                    ...
                                    foreach ($tasks as $task) {
                                        ...
                                        if ($task[3] == "0") {
                                            echo "
                                                    <tr class='task'>    
                                                        <td>$counts</td>
                                                        <td contenteditable='false' class='title'>$task[1]</td>
                                                        <td contenteditable='false' class='desc'>$task[2]</td>
                                                        <td>
            ...
            <div class="col-8 offset-2 d-flex justify-content-center align-items-center">
                <div class="d-flex flex-column">
                    <div class="d-flex flex-row"
                        ...
                        <img class="img-fluid rounded-circle m-2" src="img/jatin.jpg" alt="Jatin Kevlani">
                    ...
                    <div class="d-flex flex-row"
                        ...
                        <img class="img-fluid rounded-circle m-2" src="img/kavan.jpg" alt="Kavan Bhavsar">
        ...
        <div id="signupFormContainer" class="formContainer card-body slide-up d-none">
            <!-- <div id="signupFormContainer" class="card-body"> -->
            <div class="d-flex justify-content-end">
                <button id="closeButtonSignup" class="btn border-0 p-0" style="font-size: 30px;">
            ...
            <form class="mx-auto">
                ...
                <div class="py-2 form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" id="reg_userName" name="reg_userName" class="mx-md-2 form-control" required>
                    </div>
                </div>
                <div class="py-2 form-group row">
                    <label class="col-md-3 col-form-label" for="reg_email" style="font-weight: bold;">Email:</label>
                    <div class="col-md-9">
                        <input type="email" id="reg_email" name="reg_email" class="mx-md-2 form-control" required>
                    </div>
                </div>
                <div class="py-2 form-group row">
                    <label class="col-md-3 col-form-label" for="reg_pswd" style="font-weight: bold;">Password:</label>
                    <div class="col-md-9">
                        <input type="password" id="reg_pswd" name="reg_pswd" class="mx-md-2 form-control" required>
                    </div>
                </div>
                <div id="resultCont"></div>
                <div class="row form-group">
                    <div class="col-md-6 offset-md-4">
                        <button id="submitBtn" onclick="signup()" class="btn loginSignupButton"
                            style="margin-top: 15px;">Signup</button>
                        <!-- <p> or </p> -->
                        <!-- <button id="signupvButton"> Login</button> -->
                    </div>
                </div>
            </form>
        </div>
        <div style="display: none;">
            <form action="../backend/signup.php" method="post" id="registerForm">
                ...
                <input id="user_Email" type="email" name="user_Email" placeholder="Enter your email" id="email" />
                <input id="user_Password" type="password" name="user_Password" placeholder="Create your password" />
            </form>
        </div>

        <div id="loginFormContainer" class="formContainer card-body slide-up d-none">
            <!-- <div id="signupFormContainer" class="card-body"> -->
            <div class="d-flex justify-content-end">
                <button id="closeButtonLogin" class="btn border-0 p-0" style="font-size: 30px;">
                    <span><i class="bi bi-x"></i></span>
                </button>
            </div>
            <form action="../backend/login.php" method="post" class="mx-auto">
                ...
                <div class="py-2 form-group row">
                    <label class="col-md-3 col-form-label" for="userName" style="font-weight: bold;">Name:</label>
                    <div class="col-md-9">
                        <input type="text" id="userName" name="userName" class="form-control" required>
                    </div>
                </div>
                <div class="py-2 form-group row">
                    <label class="col-md-3 col-form-label" for="userPswd" style="font-weight: bold;">Password:</label>
                    <div class="col-md-9">
                ...
                <div class="row form-group">
                    <div class="col-md-6 offset-md-4">
                        <button onclick="login()" class="btn loginSignupButton" style="margin-top: 15px;">Login</button>
                        <!-- <p> or </p> -->
